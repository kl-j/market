...
public class Login extends javax.swing.JFrame {
    ...
    private void bttLoginActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        //yint register = (int) jSpinner1.getValue();//txtRegister
            ProductsFrm productsForm = new ProductsFrm();
            if (productsForm.validateCashierName(cashier)) {
            // Valid cashier name, proceed with other steps
            ...
            // Invalid cashier name, handle it accordingly
